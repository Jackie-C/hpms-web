(function($) {
	...
	function updatePowerElements(totalDays) {
		$("#previousDayCost").text("$ " + Math.round10(powerJsonObject.aggregations.per_month.buckets[0].per_day.buckets[totalDays-2].daily_total_cost.value, -2).toFixed(2));
	...
	function getChartData(totalDays){
		var currentDayBuckets = powerJsonObject.aggregations.per_month.buckets[0].per_day.buckets[totalDays-2];
