(function($) {
	...
	function updateValues2() {
		$("#currentEnergyUsage").text(Math.round10(jsonObject2.aggregations["per_month"].buckets[0].per_day.buckets[1].daily_total.value, -2));
		$("#previousDayEnergyUsage").text(Math.round10(jsonObject2.aggregations["per_month"].buckets[0].per_day.buckets[0].daily_total.value, -2));
		$("#dailyRunningTotal").text("$ " + Math.round10(jsonObject2.aggregations["per_month"].buckets[0].per_day.buckets[1].daily_total_cost.value, -2));
		$("#monthlyRunningTotal").text("$ " + Math.round10(jsonObject2.aggregations["per_month"].buckets[0].monthly_total_cost.value, -2));
	}
