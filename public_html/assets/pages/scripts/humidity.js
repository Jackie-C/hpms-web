(function($) {
	...
	function getWeatherHourly() {
			...
			{"size":"0","query":{"bool":{"must":[{"query_string":{"query":roomName}},{"range":{"timestamp":{"gte":"now-1d","to":"now"}}}]}},"aggs":{"per_hour":{"date_histogram":{"field":"timestamp","interval":"hour"},"aggs":{"humidity":{"avg":{"field":"humidity"}}}}}}
			);
            if (chartSelection === "Total"){
                query = JSON.stringify(
				{"size":"0","query":{"bool":{"must":[{"range":{"timestamp":{"gte":"now-1d","to":"now"}}}]}},"aggs":{"per_hour":{"date_histogram":{"field":"timestamp","interval":"hour"},"aggs":{"humidity":{"avg":{"field":"humidity"}}}}}}
				);
            }
        $.ajax({
